...
<head>
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Archivo:ital,wdth,wght@0,62..125,100..900;1,62..125,100..900&family=Pinyon+Script&display=swap" rel="stylesheet">
  ...
  <header class="header">
    ...
    */
    ...
    <a class="logo" href="<?= $site->url() ?>">
      <span class="logo-inline"> <?= $site->title()->esc() ?> </span>
      <span class="logo-inline"><?= $site->role()->esc() ?> </span>
    </a>

    <div class="nav-group">
      <div class="page-indicator"> pages: </div>
      <nav class="menu">
        <?php
        /*
          ...
          This snippet I cut, because of the social stuff
          <?php snippet('social') ?> 
        */
        ?>
